...
module SwaggerClient
  class RedelegationEntry
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'shares_dst')
        self.shares_dst = attributes[:'shares_dst']
      end
    end
    ...
    def hash
      [creation_height, completion_time, initial_balance, balance, shares_dst].hash
    end
