...
module SwaggerClient
  class InlineResponse200ApplicationVersion
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'build_tags')
        self.build_tags = attributes[:'build_tags']
      end
      ...
      if attributes.has_key?(:'go')
        self.go = attributes[:'go']
      end
    ...
    def hash
      [build_tags, client_name, commit, go, name, server_name, version].hash
    end
