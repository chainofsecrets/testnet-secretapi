...
module SwaggerClient
  class ValidatorCommission
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'max_change_rate')
        self.max_change_rate = attributes[:'max_change_rate']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          rate == o.rate &&
          max_rate == o.max_rate &&
          max_change_rate == o.max_change_rate &&
    ...
    def hash
      [rate, max_rate, max_change_rate, update_time].hash
    end
