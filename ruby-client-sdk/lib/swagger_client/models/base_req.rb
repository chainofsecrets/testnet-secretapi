...
module SwaggerClient
  class BaseReq
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'gas')
        self.gas = attributes[:'gas']
      end

      if attributes.has_key?(:'gas_adjustment')
        self.gas_adjustment = attributes[:'gas_adjustment']
      end
      ...
      if attributes.has_key?(:'simulate')
        self.simulate = attributes[:'simulate']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          sequence == o.sequence &&
          gas == o.gas &&
          gas_adjustment == o.gas_adjustment &&
          fees == o.fees &&
          simulate == o.simulate
    end
    ...
    def hash
      [from, memo, chain_id, account_number, sequence, gas, gas_adjustment, fees, simulate].hash
    end
