...
module SwaggerClient
  ...
  class InlineResponse200NodeInfoOther
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'tx_index')
        self.tx_index = attributes[:'tx_index']
      end

      if attributes.has_key?(:'rpc_address')
        self.rpc_address = attributes[:'rpc_address']
      end
    end
