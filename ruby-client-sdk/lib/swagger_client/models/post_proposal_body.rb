...
module SwaggerClient
  class PostProposalBody
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'initial_deposit')
        if (value = attributes[:'initial_deposit']).is_a?(Array)
    ...
    def hash
      [base_req, title, description, proposal_type, proposer, initial_deposit].hash
    end
