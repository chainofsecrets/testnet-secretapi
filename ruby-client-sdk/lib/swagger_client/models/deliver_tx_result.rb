...
module SwaggerClient
  class DeliverTxResult
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'gas_used')
        self.gas_used = attributes[:'gas_used']
      end

      if attributes.has_key?(:'gas_wanted')
        self.gas_wanted = attributes[:'gas_wanted']
      end
    ...
    def hash
      [code, data, gas_used, gas_wanted, info, log, tags].hash
    end
