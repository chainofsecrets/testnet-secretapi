...
# Unit tests for SwaggerClient::BaseReq
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'BaseReq' do
  before do
    # run before each test
    @instance = SwaggerClient::BaseReq.new
  end
  ...
  describe 'test an instance of BaseReq' do
    it 'should create an instance of BaseReq' do
      expect(@instance).to be_instance_of(SwaggerClient::BaseReq)
    end
  end
  ...
  describe 'test attribute "gas_adjustment"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
